# BAD Guidelines for biologic therapy for psoriasis: a rapide update (TCREI Master Template)
...
*   **정의**: BAD Guidelines for biologic therapy for psoriasis: a rapide update에 대한 임상적 정의 및 핵심 병태생리 기전.
