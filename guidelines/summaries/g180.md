# Updated algorithm recommendation for the management of knee osteoarthritis (TCREI Master Template)

본 가이드라인은 근골격질환 - 46. 골관절염에 대한 약학적 전문 지식을 집대성한 표준 가이드입니다.

---

## 1. 개요 및 병태생리 (Title & Concept)
*   **정의**: Updated algorithm recommendation for the management of knee osteoarthritis에 대한 임상적 정의 및 핵심 병태생리 기전.
