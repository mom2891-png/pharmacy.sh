# Consensus update for systemic treatment of atopic dermatitis (TCREI Master Template)

본 가이드라인은 피부과 - 2. 아토피 피부염에 대한 약학적 전문 지식을 집대성한 표준 가이드입니다.

---

## 1. 개요 및 병태생리 (Title & Concept)
*   **정의**: Consensus update for systemic treatment of atopic dermatitis에 대한 임상적 정의 및 핵심 병태생리 기전.
