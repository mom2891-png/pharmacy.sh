# European evidence-based (S3) guideline for the treatment of acne, update 2016 (TCREI Master Template)

본 가이드라인은 피부질환 - 62. 여드름에 대한 약학적 전문 지식을 집대성한 표준 가이드입니다.

---

## 1. 개요 및 병태생리 (Title & Concept)
*   **정의**: European evidence-based (S3) guideline for the treatment of acne, update 2016에 대한 임상적 정의 및 핵심 병태생리 기전.
