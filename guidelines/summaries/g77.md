# Hyponatremia: why it matters, how it presents, how we can manage it (TCREI Master Template)

본 가이드라인은 신장질환 - 18. 체액과 전해질 불균형에 대한 약학적 전문 지식을 집대성한 표준 가이드입니다.

---

## 1. 개요 및 병태생리 (Title & Concept)
*   **정의**: Hyponatremia: why it matters, how it presents, how we can manage it에 대한 임상적 정의 및 핵심 병태생리 기전.
